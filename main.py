...
def TP1():
    TP1_A = ligne(20, -5, 5)
    afficher_3D(TP1_A, titre='Ligne')

    TP1_B = carre_vide(20, 2)
    afficher_3D(TP1_B, titre='Carré vide')

    TP1_C = carre_plein(100, 2)
    afficher_3D(TP1_C, titre='Carré plein')

    TP1_D = pave_plein(1000, 2, 2, 2)
    afficher_3D(TP1_C, titre='Pavé plein')

    TP1_E = cercle_plein(50, 2)
    afficher_3D(TP1_E, titre='Cercle plein')

    TP1_F = cylindre_plein(16, 2, 3)
    afficher_3D(TP1_F, titre='Cylindre plein')
